...
export function AboutSection() {
  const { profile, education, softSkills, siteSettings } = usePortfolio()
    ...
    <section id="about" className="section">
      <div className="container">
        <div ref={headerRef} className="section__header reveal">
          ...
          <h2 className="section__title" style={{ maxWidth: '800px', lineHeight: '1.2' }}>
            {siteSettings.about_title || 'About Me'}
          </h2>
        </div>
